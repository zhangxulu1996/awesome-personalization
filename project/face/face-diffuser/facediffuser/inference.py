...
def main():
    ...
    subfolder = args.test_caption.replace("<|image|>", "*")
    # Handle the repository creation
    if accelerator.is_main_process:
        if os.path.join(args.output_dir, subfolder) is not None:
    ...
    pipe = StableDiffusionPipeline.from_pretrained(
        args.pretrained_model_name_or_path, torch_dtype=weight_dtype, local_files_only=False
    )
